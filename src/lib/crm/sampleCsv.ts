...
export const SAMPLE_CSV =
  `firstName,lastName,email,phone,company,address,city,province,country,postalCode,contactType,source,tags,notes
...
Aisha,Ahmed,aisha@globaltrade.org,555-1234,,London,UK,SW1A 1AA,UK,Global,Import,"Investor","Deal in progress; Due diligence Q3"
