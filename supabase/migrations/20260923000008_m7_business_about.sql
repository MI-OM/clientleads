-- =====================================================================
-- M7 — Separate public About copy from the business description.
--
-- `description` remains the short hero/SEO copy. `about` is the longer
-- optional About section copy. Existing organizations remain valid and
-- render the About fallback until an admin fills this field in.
-- =====================================================================

alter table public.organizations
  add column if not exists about text;

-- Re-declare the latest public page RPC so anon receives the new public-safe
-- organization field. This preserves the M4 booking-aware projection.
